            ...
            if (defaults.modalActionsTemplate) {
                ...
                for (var i = 0; i < params.length; i++) {
                    for (var j = 0; j < params[i].length; j++) {
                        ...
                        //自己外加部分
                        if(button.class) buttonClass += ' '+button.class;
                        var buttonAttr = "";
                        if(button.data_popup) buttonAttr += button.data_popup
                        //-----
                        buttonsHTML += '<span class="' + buttonClass + '" data-popup="'+buttonAttr+'">' + button.text + '</span>';
