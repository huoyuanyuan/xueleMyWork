...
(function() {
	...
	function fn() {
		...
		if (r >= 0.5 && r <= 0.8 && w <= 800) {
			document.documentElement.style.fontSize = h * 62.5 / dh + '%';
			document.documentElement.style.fontSize = h * 10 / dh + 'px';
		}
		if (r <= 2 && r >= 0.8 && h <= 800) {
			document.documentElement.style.fontSize = w * 62.5 / dh + '%';
			document.documentElement.style.fontSize = w * 10 / dh + 'px';
		}
	}
})();